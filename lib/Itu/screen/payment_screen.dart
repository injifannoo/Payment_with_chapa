...
import 'package:hellobalemoya_app/Itu/services/chapa_service.dart';
import 'package:hellobalemoya_app/Itu/services/wallet_service.dart'; // Import the wallet service
  ...
  Future<void> _initiatePayment() async {
    ...
    try {
      ...
      if (response['status'] == 'success') {
        ...
        final transactionId =
            data.containsKey('tx_ref') ? data['tx_ref'] as String : 'Unknown';
